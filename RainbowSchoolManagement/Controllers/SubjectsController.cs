    ...
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subject != null ? 
                          ...
                          Problem("Entity set 'SubjectDbContext.Subject'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Subject_id,Subject_Name,Teacher,Pending_classes")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Subject_id,Subject_Name,Teacher,Pending_classes")] Subject subject)
        {
